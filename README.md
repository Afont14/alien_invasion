...
and left using arrow keys and shoot bullets using the spacebar. When 
...
player destroys all the aliens, a new fleet appears and moves faster 
than the previous fleet. If any alien hits the player's ship or reaches
